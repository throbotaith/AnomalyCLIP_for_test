  ...
  ##########################################################################################
    ...
    for epoch in tqdm(range(args.epoch)):
        ...
        if (epoch + 1) % args.print_freq == 0:
            logger.info(
                'epoch [{}/{}], lr:{:.6f}, loss:{:.4f}, image_loss:{:.4f}'.format(
                    epoch + 1,
                    args.epoch,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--lr_step_size", type=int, default=5, help="step size for StepLR")
    parser.add_argument("--lr_gamma", type=float, default=0.1, help="decay factor for StepLR")
